...
head(Tmax)
#delete 2016
#Tmax <- Tmax[!(Tmax$date >= "2016-01-01" & Tmax$date <= "2016-12-31"), ]
...
write.csv(Tmax.ann.df,
          file="Mean Annual Max Tmp of Navrongo(1960-2107).csv")
...
ggplot(Tmax.ann.df, aes(x=date, y=Tmax)) + geom_line(col="firebrick", lwd=2) + 
  ...
  annotate("text", x= Tmax.ann.df[Tmax.ann.df[,1] == "1974-12-31", ]$date,
                                     y = 37,  label = "P-value = 0.00045192", cex = 5)

dev.copy(png, filename = "Annual Maximum Temperature of Navrongo (1960-2017).png",
         width = 1000, height = 750)
dev.off()

Mk <-MannKendall(Tmax.ann.df$Tmax)
summary(MK)
...
#eSTIMATING values fir missing months
...
write.csv(Mn.mn.tmx,
          file="Mean Monthly Tmax of Navrongo (1960-2017).csv")
...
dev.copy(png, filename = "Mean Monthly Maximum Temperature of Navrongo (1960-2017).png",
         width = 1000, height = 750)
dev.off()
...
# seasonal Cycle of Max Tmp of Navrongo
head(Tmax)
data <- Tmax
...
mean_dailytmx_Nav<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11,
...
Seasonal_cycle_Navtmx <-data.frame(
  c(1:366),
  mean_dailytmx_Nav
  )

write.csv(Seasonal_cycle_Navtmx, 
          file = "data_for_seasonal_cycle_of_Max tmp of Navrongo(1960-2017).csv")
...
ggplot(Seasonal_cycle_Navtmx, aes(x=c(1:366), y=mean_dailytmx_Nav)) + 
...
dev.copy(png, filename = "Seasonal Cycle of Maximum Temperature of Navrongo (1960-2017).png",
         width = 1000, height = 750)
dev.off()
...
#Indexing of Max tmp of Navrongo (1960-2017)
...
ggplot(Tmax.ann.df.anom, aes(Tmax.ann.df$date, Tmax.ann.df.anom.v, ymin = 0,
  ...
  labs(title="Rainfall Total Anomaly (1960-2017)\n Navrongo", 
       x="Year", y="Anomaly")

dev.copy(png, filename = "Index of Maximum Temperature of Navrongo (1960-2017).png",
         width = 1000, height = 750)
dev.off()
...
Tmax_fh <- Tmax.ann.df[(Tmax.ann.df$date >= "1960-12-01" &
...
Tmax_fh
write.csv(Tmax_fh,
          file="Annual Max.Tmp of Navrongo (1960-88).csv")
...
ggplot(Tmax_fh, aes(x=Tmax_fh$date, y=Tmax_fh$Tmax)) +
  ...
  labs(title='Maximum Temperature (1960-1988)\n Navrongo',
       x="Year", y=yyy) + 
  annotate("text", x= Tmax_fh[Tmax_fh[,1] == "1970-12-31", ]$date, y = 35.5, 
           label = "0.00045192", cex =5) + scale_x_date(date_breaks = "3 years", 
                                                        date_labels = "%Y")
...
#Subsetting all Months & #Averaging all months
...
write.csv(mean.mn.Tmaxfh,
          "Mean Monthly Tmax of Navrongo(1960-1988).csv")

ggplot(mean.mn.Tmaxfh, aes(x=date.mn, y=mean.mn.Tmaxfh.v)) + 
  geom_line(col="firebrick", lwd=2) + 
  scale_x_date(date_breaks = "1 month", date_labels = "%b") + 
  labs(title="Mean Monthly Max Tmp for Navrongo \n (1960-1988)",
       x="Month",y=yyy)

dev.copy(png, filename = "Mean Monthly Maximum Tmp of Navrongo (1960-1988).png", 
         width = 1000, height = 750)
dev.off()
...
write.csv(Tmax_sh, 
          file="Annual Tmax of Navrongo (1989-2017).csv")
...
ggplot(Tmax_sh, aes(x=Tmax_sh$date, y=Tmax_sh$Tmax)) + 
  ...
  labs(title='Maximum Temperature (1989-2017)\n Navrongo',
       x="Year", y=yyy) + 
  scale_x_date(date_breaks = "4 years", date_labels = "%Y") + 
  annotate("text", x= Tmax_sh[Tmax_sh[,1] == "1996-12-31", ]$date, y = 37, cex = 5,
           label = "P-value = 0.020805")

dev.copy(png, filename = "Annual Maximum Tmp of Navrongo (1989-2017).png", 
         width = 1000, height = 750)
dev.off()
...
Aprilx.fh <- mean(subset(Tmax.mn.dfsh,format.Date(
...
write.csv(mean.mn.Tmaxsh,
                 "Mean Monthly Tmax of Navrongo(1989-2016).csv")
...
dev.copy(png, filename = "Mean Monthly Maximum Tmp of Navrongo (1989-2017).png", 
         width = 1000, height = 750)
dev.off()
...
#plot(mean.mn.Tmaxfh, lwd=3, type="l", col="darkblue", 
#    main="Mean Monthly Max Tmp of Navrongo - 1960-2017", 
#     xlab="Months", ylab=yyy, ylim=c(30, 40))
...
ggplot(mean.mn.Tmaxfh,aes(x=mean.mn.Tmaxfh[,1]), lwd=.25) + 
  geom_line(aes(y=mean.mn.Tmaxfh[,2], colour="1960-1988"), lwd=2) + 
  geom_line(aes(y= mean.mn.Tmaxsh[,2], colour="1989-2017"), lwd=2) +
  scale_colour_manual("",
...
dev.copy(png,filename="Mean Monthly Max Tmp of Navrongo (1960-88-2017).png", 
         width = 1000, height = 750)
dev.off()
...
mean_dailytmx_Navfh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11,
                        Jan_12,Jan_13,Jan_14,Jan_15,Jan_16,Jan_17,Jan_18,Jan_19,Jan_20,Jan_21,
                        Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,Jan_29,Jan_30,Jan_31,
                        Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,Feb_37,Feb_38,Feb_39,Feb_40,Feb_41,
                        Feb_42,Feb_43, Feb_44,Feb_45,Feb_46,Feb_47,Feb_48,Feb_49,Feb_50,Feb_51,
                        ...
                        Apr_100,Apr_101,Apr_102,Apr_103,Apr_104,Apr_105,Apr_106,Apr_107,Apr_108,
...
Seasonal_cycle_Navtmxfh <-data.frame(
  c(1:366),
  mean_dailytmx_Navfh
  )

write.csv(Seasonal_cycle_Navtmxfh, 
          file = "data_for_seasonal_cycle_of_Max tmp of Navrongo(1960-1988).csv")
...
ggplot(Seasonal_cycle_Navtmxfh, aes(x=c(1:366), y=mean_dailytmx_Navfh)) + 
  geom_line(col="firebrick", lwd=1) + 
  labs(title="Seasonal Cycle of Maximum Temperature (1960-1988)\n Navrongo",
       x="Day", y=yyy) + 
  geom_line(data = aa.1, aes(x=x, y=y), col="blue", lwd=1)

dev.copy(png, filename = "Seasonal Cycle of Maximum Tmp of Navrongo (1960-1988).png", 
         width = 1000, height = 750)
dev.off()
...
mean_dailytmx_Navsh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11,
                        Jan_12,Jan_13,Jan_14,Jan_15,Jan_16,Jan_17,Jan_18,Jan_19,Jan_20,Jan_21,
                        Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,Jan_29,Jan_30,Jan_31,
                        Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,Feb_37,Feb_38,Feb_39,Feb_40,Feb_41,
                        Feb_42,Feb_43, Feb_44,Feb_45,Feb_46,Feb_47,Feb_48,Feb_49,Feb_50,Feb_51,
...
Seasonal_cycle_Navtmxsh <-data.frame(
  c(1:366),
  mean_dailytmx_Navsh
  )

write.csv(Seasonal_cycle_Navtmxsh, 
          file = "data_for_seasonal_cycle_of_Max tmp of Navrongo (1989-2017).csv")
...
ggplot(Seasonal_cycle_Navtmxsh, aes(x=c(1:366), y=mean_dailytmx_Navsh)) + 
  geom_line(col="firebrick", lwd=1) + 
  labs(title="Seasonal Cycle of Maximum Temperature (1989-2017)\n Navrongo", 
       x="Day", y=yyy) + 
  geom_line(data = bb.1, aes(x=x, y=y), col="blue", lwd=1)

dev.copy(png, filename = "Seasonal Cycle of Maximum Tmp of Navrongo (1989-2017).png", 
         width = 1000, height = 750)
dev.off()



#plot(Seasonal_cycle_Navtmxfh, lwd=1, type="l", xlab="Days",
#     ylab=yyy,col="darkblue", 
#     main="Seasonal Max Tmp Cycle of Navrongo - 1960-2017", ylim=c(30,42))

#lines(aa.1, col="blue", lwd=3)
#lines(Seasonal_cycle_Navtmxsh, lwd=1, col="darkblue")
...
ggplot(Seasonal_cycle_Navtmxfh, aes(x=Seasonal_cycle_Navtmxfh[,1]), lwd=.25) + 
  geom_line(aes(y=Seasonal_cycle_Navtmxfh[,2]), lwd=.25) + 
  geom_line(aes(y=aa.1[,2], col= "1960-1988"), lwd= 1.25) + 
  geom_line(aes(y=Seasonal_cycle_Navtmxsh[,2]), lwd=.25) + 
...
dev.copy(png, filename="Seasonal Cycle of Max Tmp of Navrongo(1960-88-2017).png", 
         width =1000, height = 750)
dev.off()
...
#  labs(title="Index of Annual Maximum Tmp of Navrongo \n (1960-1988)", x="Years", y="Index")
#dev.copy(png, filename = "Inex of Annual Maximum Tmp of Navrongo (1960-1988).png", 
#         width = 1000, height = 750)
#dev.off()
