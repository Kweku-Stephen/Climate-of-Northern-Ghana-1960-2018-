...
#Imputation/estimation of missing values
      #Replacing all 0.0s in Prcp.df.ann data with NA
      Prcp.df.ann$Prcp <- replace(
        Prcp.df.ann$Prcp,
        Prcp.df.ann$Prcp == 0.0, NA
)
          
Prcp.df.ann$Prcp <- na.kalman(
  Prcp.df.ann$Prcp, model = "StructTS",
  smooth = T, nit = -1
)

head(Prcp.df.ann)
write.csv(Prcp.df.ann, 
          file="Annual Rainfall of Bole(1960-2017).csv")
...
ggplot(Prcp.df.ann, aes(x=date, y=Prcp)) + geom_line(col="darkblue", lwd=2) + 
  ...
  labs(title="Rainfall  Total (1960-2017)\n Bole", x="Year", y="Rainfall(mm)") + 
  scale_x_date(date_breaks = "4 years", date_labels = "%Y") + 
  annotate("text", x = Prcp.df.ann[Prcp.df.ann[,1] == "1978-12-31", ]$date,
           y=1800, label="P-value = 0.56855", cex = 5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainfall of Bole (1960-2017).png",
...
write.csv(sum11,
          file = "summary stats for Annual Prcp.1 (Bole).csv")
...
Prcp.xts.1 <- xts(Prcp.xts.1$Prcp, Prcp.xts.1$dates)
Prcp.mn.xts <- apply.monthly(Prcp.xts.1, sum, na.rm=T)
head(Prcp.mn.xts)
...
write.csv(mean.mn.Prcp, 
          file="Mean Monthly Rainfall of Bole(1960-2017).csv")

ggplot(mean.mn.Prcp, aes(x=date.mn, y=mean.mn.Prcp.v)) + 
  geom_line(col="darkblue", lwd=2) +
  scale_x_date(date_breaks = "1 month", date_labels = "%b") + 
  labs(title="Mean Monthly Rainfall of Bole \n (1960-2017)",
       x="Months",y="Rainfall(mm)") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Mean Monthly Rainfall of Bole (1960-2017).png", 
...
sum22[-c(3,4)] -> sum22
sum22[,1] <- data.frame(month.name[c(09,01)])
dimnames(sum22) <- list(
  c("Max:","Min:"), 
  c("Month","Rainfall")
)  
...
write.csv(sum22,
          file = "summary stats for mean mOnth Prcp.1 (Wa).csv")



#Annual Rainy Days of Bole
...
#Excluding missing cases (1965 and 2015)
Ann.rndys.v <- c(b.60.1, b.61.1, b.62.1, b.63.1, b.64.1, b.65.1,b.66.1, b.67.1, b.68.1 
                 ,b.69.1, b.70.1, b.71.1, b.72.1, b.73.1, b.74.1, 
                 b.75.1, b.76.1, b.77.1, b.78.1, b.79.1, b.80.1, b.81.1,
                 b.82.1, b.83.1, b.84.1, b.85.1, b.86.1, 
                 b.87.1, b.88.1, b.89.1, b.90.1, b.91.1, b.92.1, b.93.1, 
                 b.94.1, b.95.1, b.96.1, b.97.1, 
                 b.98.1, b.99.1, b.00.1, b.01.1, b.02.1, b.03.1, b.04.1, 
                 b.05.1, b.06.1, b.07.1, b.08.1, b.09.1, 
...
write.csv(Ann.rndys, 
          file="Annual Rainy Days of Bole (1960-2017).csv")
...
ggplot(Ann.rndys, aes(x=date.ann, y=Ann.rndys.v)) + 
  ...
  labs(title="Number of Days when Rainfall >= 0.85mm (1960-2017)\n Bole", 
       x="Year",y="Day") + 
  geom_smooth(method = lm, col="red") + 
  annotate("text", x=Ann.rndys[Ann.rndys[,1] == "1979-01-01", ]$date.ann, 
           y= 100, label="P-value=0.20261", cex=5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainy Days of Bole (1960-2017).png", 
         height=750, width=1000)
dev.off()
...
write.csv(sum33,
          file = "summary stats for ann rainy days (Wa).csv")
...
Ann.rndys20.v <- c(b.60.2, b.61.2, b.62.2, b.63.2, b.64.2, b.65.2, b.66.2, b.67.2, b.68.2 ,
                   b.69.2, b.70.2, b.71.2, b.72.2, b.73.2, b.74.2, b.75.2, b.76.2, 
                   b.77.2, b.78.2, b.79.2, b.80.2, b.81.2, b.82.2, b.83.2, b.84.2, 
                   b.85.2, b.86.2, b.87.2, b.88.2, b.89.2, b.90.2, b.91.2, b.92.2, 
                   b.93.2, b.94.2, b.95.2, b.96.2, b.97.2, b.98.2, b.99.2, b.00.2, 
                   b.01.2, b.02.2, b.03.2, b.04.2, b.05.2, b.06.2, b.07.2, b.08.2, 
...
Ann.rdys20.Bole <- data.frame(
  date.rdys20,
  Ann.rndys20.v
)

#Excluding 1965 and 2015
Ann.rdys20.Bole <- Ann.rdys20.Bole[!(Ann.rdys20.Bole[,1] == "1965-01-01" | 
                           Ann.rdys20.Bole[,1] == "2015-01-01"), ]

MK <- MannKendall(Ann.rdys20.Bole[,2])
summary(MK)

write.csv(Ann.rdys20.Bole, 
          file="Annual Rainy Days of Bole grt than 20mm (1960-2017).csv")

ggplot(Ann.rdys20.Bole, aes(x=date.rdys20, y=Ann.rndys20.v)) + 
  ...
  annotate("text",x=Ann.rdys20.Bole[Ann.rdys20.Bole[,1] == "1979-01-01", ]$date.rdys20, 
           y= 30, label="P-value = 0.84812", cex=5 ) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainy Days of Bole grt 20mm (1960-2017).png",
         width=1000, height=750)
dev.off()

sum4 <- summary(Ann.rdys20.Bole)
#or
#or
sum44 <- data.frame(Ann.rdys20.Bole[Ann.rdys20.Bole[,2] == max(Ann.rdys20.Bole[,2]), ],
                    Ann.rdys20.Bole[Ann.rdys20.Bole[,2] == min(Ann.rdys20.Bole[,2]), ])
...
write.csv(sum44,
          file = "summary stats for ann rainy days grt 20 (Wa).csv")
...
Bole.ann.rdys <- c(J,F,M,A,Ma,Ju,Jl,Au,S,O,N,D)
date.mn
monthly.rdys <- data.frame(date.mn,Bole.ann.rdys) 
write.csv(monthly.rdys, 
          file = "Monthly Rainy Days of Babile (1960-2014).csv")

ggplot(monthly.rdys, aes(x=date.mn, y=Bole.ann.rdys)) + 
  geom_line(col="darkblue", lwd=2) + 
  labs(title="Number of Days when Rainfall >= 0.85mm (1960-2017)\n Bole", 
...
sum55[-c(3,4)] -> sum55
sum55[,1] <- data.frame(month.name[c(09,01)])
dimnames(sum55) <- list(
  c("Max:","Min:"), 
  c("Month","Rainfall(mm)")
)  
...
write.csv(sum55,
          file = "summary stats for monthly rainy days (Wa).csv")
...
#creating a vector with the aboves
Bole.ann.rdys20 <- c(J.1,F.1,M.1,A.1,Ma.1,Ju.1,
...
write.csv(monthly.rdys20, 
          file = "Monthly Rainy Days of Bole grt 20 (1960-2017).csv")

ggplot(monthly.rdys20, aes(x=date.mn, y=Bole.ann.rdys20)) + 
  geom_line(col="darkblue", lwd=2) + 
  labs(title="Number of Days when Monthlainfall >= 20mm (1960-2017)\n Bole",
       x="Month", y="Rainfall(mm)") + 
  scale_x_date(date_breaks = "1 month", date_labels = "%b") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
...
dev.copy(png, filename="Monthly Rainy Days of Bole  grt 20mm (1960-2017)",
         height = 500, width = 1000)
dev.off()
...
sum66[-c(3,4)] -> sum66
sum66[,1] <- data.frame(month.name[c(09,01)])
dimnames(sum66) <- list(
  c("Max:","Min:"), 
  c("Month","Rainfall(mm)")
)  
...
write.csv(sum66,
          file = "summary stats for monthly rainy days grt 20mm (Wa).csv")
...
write.csv(Prcp.df.ann.anom, 
          file="Data for index of Annual Rainfall of Bole (1960-2017).csv")
...
dev.copy(png, filename="Index of Annual Rainfall of Bole(1960-2017).png", 
         width=1000, height=750)
dev.off()
...
write.csv(sum77,
          file = "summary stats for annual Prcp Anomaly (Wa).csv")
...
ggplot(Seasonal_cycle_Bole, aes(x=c(1:366), y=mean_daily_Bole)) + 
  geom_line(col="darkblue", lwd=1) + 
  labs(title="Seasonal Cycle of Rainfall (1960-201R7)\nRainfall ",
       x="Day", y="Rainfall(mm)") + 
...
dev.copy(png, filename="Seasonal Cycle of Annual Rainfall of Bole (1960-2017).png", 
         width=1000, height=750)
dev.off()
...
#Dividing Prcp into two halves
          #Dividing daily Prcp
head(Prcp)
Prcp.fh <- Prcp[(Prcp$dates >= "1960-01-01" & Prcp$dates <= "1988-12-31"), ]
Prcp.sh <- Prcp[(Prcp$dates >= "1989-01-01" & Prcp$dates <= "2017-12-31"), ]
...
Prcp_fh
#Dropping 1961
Prcp_fh <- Prcp_fh[!Prcp_fh[,1] == "1961-12-31", ]

write.csv(Prcp_fh, file="Annual Prcp of Bole (1960-88).csv")
MK <- MannKendall(Prcp_fh[,2])
summary(MK)

ggplot(Prcp_fh, aes(x=Prcp_fh$date, y=Prcp_fh$Prcp)) + 
  geom_line(col="darkblue", lwd=2) + 
  geom_smooth(method = lm, col="red") + 
  labs(title='Annual Rainfall Total (1960-1988)\n Bole', x="Year",
       y="Rainfall(mm)") + 
  annotate("text", x=Prcp_fh[Prcp_fh[,1] == "1972-12-31", ]$date,
           y = 2000, label="P-value = 0.060536", cex=5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainfall of Bole (1960-1988).png",
         width=1000, height=750)
dev.off()
...
Prcp.mn.dfsh <- Prcp.mn.df[(Prcp.mn.df$date >= "1989-01-31" &
         ...
         #creating a vector
         mean.mn.Prcpfh.v <- c(Jan.fh,Feb.fh,March.fh,April.fh,May.fh,June.fh,
                               July.fh,August.fh,September.fh,October.fh,November.fh,
                               December.fh)
         date.mn 
         ...
         write.csv(mean.mn.Prcpfh, 
                   file="Mean Monthly Rainfall of Bole (1960-1988).csv")
         ...
         dev.copy(png, filename="Mean Monthly Rainfall of Bole (1960-1988).png", 
         width=1000, height=750)
         dev.off()
        ...
        #or
         ...
         sum88[-c(3,4)] -> sum88
         sum88[,1] <- data.frame(month.name[c(09,01)])
         dimnames(sum88) <- list(
           c("Max:","Min:"), 
           c("Month","Rainfall(mm)")
         )  
...
head(Prcp_sh)
MK <- MannKendall(Prcp_sh[,2])
summary(MK)

write.csv(Prcp_sh, 
          file="Annual Prcp of Bole (1989-2017).csv")

#ggplot(Prcp_sh, aes(x=Prcp_sh$date, y=Prcp_sh$Prcp)) + 
#  geom_line(col="darkblue", lwd=2) + geom_smooth(method = lm, col="red") + 
#  labs(title='ANNUAL Rainfall of Bole \n (1989-2017)', x="Years", y="Rainfall(mm)") + 
#  scale_x_date(date_breaks = "3 years", date_labels = "%Y") +
#  annotate("text", x=Prcp_sh[Prcp_sh[,1] == "1997-12-31", ]$date,
#           y = 1400, label="P-value = 0.49942", cex=5)
  
#dev.copy(png, filename="Annual Rainfall of Bole (1989-2017).png", 
#         height=750, width=1000)
#dev.off()
...
#second Half
         ...
         write.csv(mean.mn.Prcpsh,
                   file="Mean Monthly Rainfall of Babile (1988-2017).csv")
         ...
         dev.copy(png, filename="Mean Monthly Rainfall of Bole (1989-2017).png", 
                  width=1000, height=750)
         dev.off()
         ...
         sum99[-c(3,4)] -> sum99
         sum99[,1] <- data.frame(month.name[c(09,01)])
         dimnames(sum99) <- list(
           c("Max:","Min:"), 
           c("Month","Rainfall(mm)")
         )  
...
#plot(mean.mn.Prcpfh, lwd=3, type="l",lty=1, col="darkblue", 
#      main="Mean monthly Rainfall of Bole (1960-1988, 1989-2017", 
#      xlab="Months",ylab="Rainfall(mm)", ylim=c(0,200))   

#lines(mean.mn.Prcpsh, col="red", lwd=3)

#legend("topright", legend = c("1960-1988","1989-2017"),
#       lty = 1, bty = "n", lwd=3, 
#       col=c("darkblue","red"))
#grid()
...
ggplot(mean.mn.Prcpfh, aes(x= mean.mn.Prcpfh[,1])) + 
  ...
  geom_line(aes(y=mean.mn.Prcpsh[,2], col = "1989-2017"), size = 2) +
  scale_colour_manual("",
...
dev.copy(png, filename="Mean Monthly Rainfall of Bole (1960-89-2017).png", 
         width=1000, height=750)
dev.off() 
...
ggplot(data = data.frame(c(1:28), Ann.rndys_fh[,2]),aes(x=c(1:28))) +
...
Ann.rndys20_fh <- Ann.rdys20.Bole[Ann.rdys20.Bole[,1] >= "1960-01-01" &
                                        Ann.rdys20.Bole[,1] <= "1988-01-01", ]

Ann.rndys20_sh <- Ann.rdys20.Bole[Ann.rdys20.Bole[,1] >= "1989-01-01" &
                                        Ann.rdys20.Bole[,1] <= "2017-01-01", ]

#introducing another row to make Ann.rndys20.Zua[,2] == Ann.rndys20.Zua[,2], 
#so we can plot both
#Ann.rndys20_sh[29,2] <- NA   

ggplot(data = data.frame(c(1:28), Ann.rndys20_fh[,2]),aes(x=c(1:28))) +
...
dev.copy(png,filename="Comparing Days with Rainfall grt 20mm Bole.png",
         width = 1000, height = 750)
dev.off
...
mean_daily_Bolefh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11, Jan_12,Jan_13,Jan_14,
                      Jan_15,Jan_16,Jan_17,Jan_18,Jan_19,Jan_20,Jan_21,Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,
                      Jan_29,Jan_30,Jan_31,Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,Feb_37,Feb_38,Feb_39,Feb_40,Feb_41,Feb_42,Feb_43, 
                      Feb_44,Feb_45,Feb_46,Feb_47,Feb_48,Feb_49,Feb_50,Feb_51,Feb_52,Feb_53,Feb_54,Feb_55,Feb_56,Feb_57,Feb_58,Feb_59,
                      Feb_59_1,Mar_60, Mar_61,Mar_62,Mar_63,Mar_64,Mar_65,Mar_66,Mar_67,Mar_68,Mar_69,Mar_70,Mar_71,Mar_72,Mar_73,Mar_74,
                      Mar_75,Mar_76,Mar_77,Mar_78,Mar_79,Mar_80,Mar_81,Mar_82,Mar_83,Mar_84,Mar_85,Mar_86,Mar_87,Mar_88,Mar_89,Mar_90,Apr_91,
                      Apr_92,Apr_93,Apr_94,Apr_95,Apr_96,Apr_97,Apr_98,Apr_99,Apr_100,Apr_101,Apr_102,Apr_103,Apr_104,Apr_105,Apr_106,Apr_107,
...
Seasonal_cycle_Bolefh <-data.frame(
  c(1:366),
  mean_daily_Bolefh
  )

write.csv(Seasonal_cycle_Bolefh, 
          file = "data_for_seasonal_cycle_of_Rainfall of Bole(1960-1988).csv")
...
ggplot(Seasonal_cycle_Bolefh, aes(x=c(1:366), y=mean_daily_Bolefh)) + 
  geom_line(col="darkblue", lwd=1) + 
...
dev.copy(png, filename="Seasonal Cycle of AAnnuAl Rainfall of Bole (1960-1988).png", 
         width=1000, height=750)
dev.off()
...
mean_daily_Bolesh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11, Jan_12,Jan_13,Jan_14,Jan_15,Jan_16,Jan_17,Jan_18,
                      Jan_19,Jan_20,Jan_21,Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,Jan_29,Jan_30,Jan_31,Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,
                      Feb_37,Feb_38,Feb_39,Feb_40,Feb_41,Feb_42,Feb_43, Feb_44,Feb_45,Feb_46,Feb_47,Feb_48,Feb_49,Feb_50,Feb_51,Feb_52,Feb_53,Feb_54,
                      Feb_55,Feb_56,Feb_57,Feb_58,Feb_59,Feb_59_1,Mar_60, Mar_61,Mar_62,Mar_63,Mar_64,Mar_65,Mar_66,Mar_67,Mar_68,Mar_69,Mar_70,Mar_71,
                      Mar_72,Mar_73,Mar_74,Mar_75,Mar_76,Mar_77,Mar_78,Mar_79,Mar_80,Mar_81,Mar_82,Mar_83,Mar_84,Mar_85,Mar_86,Mar_87,Mar_88,Mar_89,Mar_90,
                      Apr_91,Apr_92,Apr_93,Apr_94,Apr_95,Apr_96,Apr_97,Apr_98,Apr_99,Apr_100,Apr_101,Apr_102,Apr_103,Apr_104,Apr_105,Apr_106,Apr_107,Apr_108,
                      Apr_109,Apr_110,Apr_111,Apr_112,Apr_113,Apr_114,Apr_115,Apr_116,Apr_117,Apr_118,Apr_119,Apr_120,May_121,May_122,May_123,May_124,May_125,
                      May_126,May_127,May_128,May_129,May_130,May_131,May_132,May_133,May_134,
                      May_135,May_136,May_137,May_138,May_139,May_140,May_141,May_142,May_143,
                      May_144,May_145,May_146,May_147,May_148,May_149,May_150,May_151,Jun_152,
                      ...
                      Jun_171,Jun_172,Jun_173,Jun_174,Jun_175,Jun_176,Jun_177,Jun_178,Jun_179,
                      Jun_180,Jun_181,Jul_182,Jul_183,Jul_184,Jul_185,Jul_186,Jul_187,Jul_188,
                      Jul_189,Jul_190,Jul_191,Jul_192,Jul_193,Jul_194,Jul_195,Jul_196,Jul_197,
                      Jul_198,Jul_199,Jul_200,Jul_201,Jul_201,Jul_203,Jul_204,Jul_205,Jul_206,Jul_207,Jul_208,Jul_209,Jul_210,Jul_211,Jul_212,Aug_213,Aug_214,Aug_215,Aug_216,Aug_217,Aug_218,Aug_219,Aug_220,Aug_221,Aug_222,Aug_223,Aug_224,Aug_225,Aug_226,Aug_227,Aug_228,Aug_229,Aug_230,Aug_231,Aug_232,Aug_233,Aug_234,Aug_235,Aug_236,Aug_237,Aug_238,Aug_239,Aug_240,Aug_241,Aug_242,Aug_243,Sep_244,Sep_245,Sep_246,Sep_247,Sep_248,Sep_249,Sep_250,Sep_251,Sep_252,Sep_253,Sep_254,Sep_255,Sep_256,Sep_257,Sep_258,Sep_259,Sep_260,Sep_261,Sep_262,Sep_263,Sep_264,Sep_265,Sep_266,Sep_267,Sep_268,Sep_269,Sep_270,Sep_271,Sep_272,Sep_273,Oct_274,Oct_275,Oct_276,Oct_277,Oct_278,Oct_279,Oct_280,Oct_281,Oct_282,Oct_283,Oct_284,Oct_285,Oct_286,Oct_287,Oct_288,Oct_289,Oct_290,Oct_291,Oct_292,Oct_293,Oct_294,Oct_295,Oct_296,Oct_297,Oct_298,Oct_299,Oct_300,Oct_301,Oct_302,Oct_303,Oct_304,Nov_305,Nov_306,Nov_307,Nov_308,Nov_309,Nov_310,Nov_311,Nov_312,Nov_313,Nov_314,Nov_315,Nov_316,Nov_317,Nov_318,Nov_319,Nov_320,Nov_321,Nov_322,Nov_323,Nov_324,Nov_325,Nov_326,Nov_327,Nov_328,Nov_329,Nov_330,Nov_331,Nov_332,Nov_333,Nov_334,Dec_335,Dec_336,Dec_337,Dec_338,Dec_339,Dec_340,Dec_341,Dec_342,Dec_343,Dec_344,Dec_345,Dec_346,Dec_347,Dec_348,Dec_349,Dec_350,Dec_351,Dec_352,Dec_353,Dec_354,Dec_355,Dec_356,Dec_357,Dec_358,Dec_359,Dec_360,Dec_361,Dec_362,Dec_363,Dec_364,Dec_365)

Seasonal_cycle_Bolesh <-data.frame(
  c(1:366),
  mean_daily_Bolesh
)

write.csv(Seasonal_cycle_Bolesh, 
          file = "data_for_seasonal_cycle_of_Rainfall of Bole(1989-2017).csv")
...
ggplot(Seasonal_cycle_Bolesh, aes(x=c(1:366), y=mean_daily_Bolesh)) + 
  geom_line(col="darkblue", lwd=1) + 
...
dev.copy(png, filename="Seasonal Rainfall Cycle of Bole (1989-2017).png",
         width=1000, height=750)
dev.off()


#plot(Seasonal_cycle_Bolefh, lwd=1, lty=1, type="l",
#     main="Seasonal Rainfall Cycle for both halves of 1960-2017", 
#    xlab="Days",ylab="Rainfall(mm)", col="darkblue")

#lines(sss.1, col="blue", lwd=3)
#lines(Seasonal_cycle_Bolesh, col="darkblue", type="l")
#lines(ww.1, col="red", lwd=3)
...
ggplot(Seasonal_cycle_Bolefh, aes(x=Seasonal_cycle_Bolefh[,1])) + 
  geom_line(aes(y=Seasonal_cycle_Bolefh[,2]),lwd = .25)+
  geom_line(aes(y = sss.1[,2], col = "1960-1988"), lwd = 1.25) + 
  geom_line(aes(y=Seasonal_cycle_Bolesh[,2]),lwd = .25) + 
  geom_line(aes(y= ww.1[,2], col = "1989-2016"), lwd = 1.25) +
  scale_colour_manual("",
                      values = c("1960-1988"="darkblue","1989-2016"="red")) +
  labs(title = "Seasonal Cycle of Annual Rainfall (1960-2016)\n Bole", 
  x = 'Day',y="Rainfall(mm)") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Seasonal Rainfall Cycle of Bole (1960-88-2017).png",
         width=1000, height=750)
dev.off()
...
##Indexing Annual Rainfall first hailf (Bole)
#head(Prcp_fh)
#lng.mn.Prcp_fh <- mean(Prcp_fh$Prcp)
#sd.mn.Prcp_fh <- sd(Prcp_fh$Prcp)

#Prcp.dffh.anom.v <- (Prcp_fh$Prcp - lng.mn.Prcp_fh)/
#  sd.mn.Prcp_fh

#Prcp_fh_anom <- data.frame(
#  Prcp_fh[,1], 
#  Prcp.dffh.anom.v
#)

#write.csv(Prcp_fh_anom, 
#          file="Data for index of Annual Rainfall of Bole (1960-1988).csv")

#ggplot(Prcp_fh_anom, aes(Prcp_fh[,1], Prcp.dffh.anom.v, ymin = 0,ymax = Prcp.dffh.anom.v)) + 
# geom_linerange(data = Prcp_fh_anom, aes(colour = ifelse(Prcp.dffh.anom.v >0, 
#            "Positive", "Negative")),stat = "identity",position = "identity",size=2) + 
#  theme(legend.title = element_text(size = 2, colour = F)) + 
#  (scale_x_date(date_breaks="4 years",date_labels="%Y"))  +
#  geom_hline(yintercept=0) + 
#  labs(title="Index of Annual Rainfall of Bole \n (1960-1988)", x="Years", y="Index")

#dev.copy(png, filename="Index of Annual Rainfall of Bole(1960-1988).png", 
#         width=1000, height=750)
#dev.off()


##Indexing Annual Rainfall Second hailf (Bole)
#head(Prcp_sh)
#lng.mn.Prcp_sh <- mean(Prcp_sh$Prcp)
#sd.mn.Prcp_sh <- sd(Prcp_sh$Prcp)#

#Prcp.dfsh.anom.v <- (Prcp_sh$Prcp - lng.mn.Prcp_sh)/
#  sd.mn.Prcp_sh

#Prcp_sh_anom <- data.frame(
#  Prcp_sh[,1], 
#  Prcp.dfsh.anom.v
#)

#write.csv(Prcp_sh_anom, 
#          file="Data for index of Annual Rainfall of Bole (1989-2017).csv")

#ggplot(Prcp_sh_anom, aes(Prcp_sh[,1], Prcp.dfsh.anom.v, ymin = 0,ymax = Prcp.dfsh.anom.v)) + 
#  geom_linerange(data = Prcp_sh_anom, aes(colour = ifelse(Prcp.dfsh.anom.v >0, 
#     "Positive", "Negative")),stat = "identity",position = "identity",size=2) + 
#  theme(legend.title = element_text(size = 2, colour = F)) + 
#  (scale_x_date(date_breaks="4 years",date_labels="%Y"))  +
#  geom_hline(yintercept=0) + 
...
#dev.copy(png, filename="Index of Annual Rainfall of Bole(1989-2017).png", 
#        width=1000, height=750)
#ev.off()
