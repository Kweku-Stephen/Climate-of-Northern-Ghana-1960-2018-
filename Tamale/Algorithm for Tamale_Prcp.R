...
write.csv(Prcp.df.ann, 
          file="Annual Rainfall of Tamale(1960-2016).csv")
...
ggplot(Prcp.df.ann, aes(x=date, y=Prcp)) + 
  ...
  annotate("text", x=Prcp.df.ann[Prcp.df.ann[,1] == "1974-12-31", ]$date,
           y = 1600, label="P-value = 0.22306", cex = 5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainfall of Tamale (1960 - 2016).png",
         width=1000, height=750)
dev.off()
sum <- summary(Prcp.df.ann)
write.csv(sum,
          file="summsry stats for annual Prcp of Tamale.csv")
...
write.csv(sum11,
          file = "summary stats for Annual Prcp.1 (Tmale).csv")
...
#exporting to excel and replace NA equivalents with NA
#write.csv(Prcp.mn.df, file="pp.csv")
...
write.csv(mean.mn.Prcp,
          file="Mean Monthly Rainfall of Tamale (1960-2016).csv")
...
dev.copy(png, filename="Mean Monthly Rainfall of Tamale (1960 - 2016).png", 
         width=1000, height=750)
dev.off()
sum1 <- summary(mean.mn.Prcp)
write.csv(sum1, 
          file="summary stats for mean monthly Prcp of Tamle.csv")
...
write.csv(sum22,
          file = "summary stats for mean mOnth Prcp.1 (Tmale).csv")



#Annual Rainy Days of Tamale
...
#to
b.16.1 <- nrow(
  subset(Prcp.xts.df, format.Date(Prcp.xts.df$date, "%y")=="16")
...
Ann.rndys.v <- c(b.60.1,b.61.1, b.62.1, b.63.1, b.64.1,b.65.1,b.66.1, b.67.1, b.68.1 ,b.69.1, 
                 b.70.1, 
                 b.71.1, b.72.1, b.73.1, b.74.1, b.75.1, b.76.1, b.77.1, b.78.1, b.79.1, 
                 b.80.1, b.81.1, 
                 b.82.1, b.83.1, b.84.1, b.85.1, b.86.1, b.87.1, b.88.1, b.89.1, b.90.1,
                 b.91.1, b.92.1, 
                 b.93.1, b.94.1, b.95.1, b.96.1, b.97.1, b.98.1, b.99.1, b.00.1, b.01.1,
                 b.02.1, b.03.1, 
                 b.04.1, b.05.1, b.06.1, b.07.1, b.08.1, b.09.1, b.10.1, b.11.1, b.12.1,
                 b.13.1, b.14.1, 
                 b.15.1,b.16.1)
...
write.csv(Ann.rndys, 
          file="Annual Rainy Days of Tamale (1960-2016).csv")

ggplot(Ann.rndys, aes(x=date.ann, y=Ann.rndys.v)) + 
  geom_line(col="darkblue", lwd=2) +
  scale_x_date(date_breaks = "4 years", date_labels = "%Y") + 
  labs(title="Number of Days when Rianfall >= 0.85mm (1960-2016)\n Tamale", 
       x="Year",y="Day") + 
  geom_smooth(method = lm, col="red") + 
  annotate("text", x=Ann.rndys[Ann.rndys[,1] == "1980-01-01", ]$date, 
           y = 90, label="P-value = 0.0047111", cex = 5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Rainy Days of Tamale (1960 - 2016).png",
         width=1000, height=750)
dev.off()
sum2 <- summary(Ann.rndys)
write.csv(sum2,
          file = "Summary stats for annual rainy dayas of Tamle.csv")
...
write.csv(sum33,
          file = "summary stats for ann rainy days (Tmale).csv")
...
Ann.rndys20.v <- c(b.60.2, b.61.2,b.62.2, b.63.2, b.64.2,b.65.2,b.66.2, b.67.2, 
                   ...
                   b.84.2, b.85.2, b.86.2, b.87.2, b.88.2, b.89.2, b.90.2, b.91.2, b.92.2, 
                   b.93.2, b.94.2, b.95.2, b.96.2, b.97.2, b.98.2, b.99.2, b.00.2, b.01.2,
                   b.02.2, b.03.2, b.04.2, b.05.2, b.06.2, b.07.2, b.08.2, b.09.2, b.10.2,
                   b.11.2, b.12.2, b.13.2, b.14.2, b.15.2, b.16.2)
...
Ann.rdys20.Tamale <- data.frame(
  date.rdys20,
  Ann.rndys20.v
  )

MK <- MannKendall(Ann.rdys20.Tamale[,2])
summary(MK)


write.csv(Ann.rdys20.Tamale,
          file="Annual Rainy Days of Tamale grt than 20mm (1960-2016).csv")

ggplot(Ann.rdys20.Tamale, aes(x=date.rdys20, y=Ann.rndys20.v)) + 
  geom_line(col="darkblue", lwd=2) + geom_smooth(method = lm, col="red") + 
  scale_x_date(date_breaks = "4 years", date_labels = "%Y") + 
  ggtitle("Number of Days when Rainfall >= 20mm (1960-2016)\n Tamale") + xlab("Year") +
  ylab("Day") +
  annotate("text", x=Ann.rdys20.Tamale[Ann.rdys20.Tamale[,1] == "1980-01-01", ]$date,
           y = 33, label="P-value =0.034374", cex = 5) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))
...
sum3 <- summary(Ann.rdys20.Tamale)
write.csv(sum3,
          file="summary stats for annual rainy days grt 20mm of Tamle.csv")

sum44 <- data.frame(Ann.rdys20.Tamale[Ann.rdys20.Tamale[,2] == max(Ann.rdys20.Tamale[,2]), ],
                    Ann.rdys20.Tamale[Ann.rdys20.Tamale[,2] == min(Ann.rdys20.Tamale[,2]), ])

sum44[c(2,3),c(1,2)] <- sum44[c(1,2), c(3,4)] 
sum44[-c(3,4)] -> sum44
#sum33[,1] <- data.frame(month.name[c(09,01)])
dimnames(sum44) <- list(
  c("Max:","Min:","//"), 
...
write.csv(sum44,
          file = "summary stats for ann rainy days grt 20 (Tmale).csv")
...
Tamale.ann.rdys <- c(J,F,M,A,Ma,Ju,Jl,Au,S,O,N,D)
date.mn
...
write.csv(monthly.rdys, 
          file = "Monthly Rainy Days of Tamale (1960-2016).csv")
...
dev.copy(png, filename="Monthly Rainy Days of Tamale (1960-2017).png", 
...
write.csv(sum55,
          file = "summary stats for monthly rainy days (Tmale).csv")
...
#creating a vector with the aboves
Tamale.ann.rdys20 <- c(J.1,F.1,M.1,A.1,Ma.1,Ju.1,
...
write.csv(monthly.rdys20, 
          file = "Monthly Rainy Days of Tamale grt 20 (1960-2016).csv")

ggplot(monthly.rdys20, aes(x=date.mn, y=Tamale.ann.rdys20)) + 
  geom_line(col="darkblue", lwd=2) +
...
dev.copy(png, filename="Monthly Rainy Days of Tamale grt 20mm (1960-2017).png", 
         height = 750, width = 1000)
dev.off()
sum4 <- summary(monthly.rdys20)
write.csv(sum4,
          file = "summary stats for monthly rainy days grt 20mm of Tamale.csv")
...
write.csv(sum66,
          file = "summary stats for monthly rainy days grt 20mm (Tmale).csv")
...
write.csv(Prcp.df.ann.anom, 
          file = "Index of Annual Rainfall of Taamale(1960-2016).csv")

ggplot(Prcp.df.ann.anom, aes(date.ann.1, Prcp.df.ann.anom.v, ymin = 0,
ymax = Prcp.df.ann.anom.v)) + geom_linerange(data = Prcp.df.ann.anom, 
  aes(colour = ifelse(Prcp.df.ann.anom.v >0, "Positive", "Negative")),stat = "identity",
...
dev.copy(png, filename="Index of Annual Rainfall of Tamale (1960-2017).png", 
         height = 750, width = 1000)
dev.off()
sum5 <- summary(Prcp.df.ann.anom)
write.csv(sum5,
          file = "summary stats for anomaly of Annual Prcp of Tamale.csv")
...
write.csv(sum77,
          file = "summary stats for annual Prcp Anomaly (Tmale).csv")




#Seasonal Cycle of Rainfall of Tamale (1960-2016)
head(Prcp)
#let Prcp,
data <- Prcp
...
mean_daily_Tamale<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11, 
...
Seasonal_cycle_Tamale <-data.frame(
  c(1:366),
  mean_daily_Tamale
  )

write.csv(Seasonal_cycle_Tamale, 
          file = "data_for_seasonal_cycle_of_Rainfall of Tamale(1960-2016).csv")
...
dev.copy(png, filename="Seasonal Cycle of Annual Rainfall of Tamale(1960-2017).png", 
         height = 750, width = 1000)
dev.off()
...
Prcp.sh <- Prcp[(Prcp$dates >= "1989-01-01" & Prcp$dates <= "2016-12-31"), ]

#Dividing annual Prcp
Prcp_fh <- Prcp.df.ann[(Prcp.df.ann$date >= "1960-12-31" & 
                          Prcp.df.ann$date <= "1988-12-31"), ]
write.csv(Prcp_fh,file="Annual Rainfall of Tamale(1960-1988).csv")

Prcp_sh <- Prcp.df.ann[(Prcp.df.ann$date >= "1989-12-31" &
                          Prcp.df.ann$date <= "2016-12-31"), ]
write.csv(Prcp_sh,file = "Annual Rainfall Total of Tamale(1989-2016).csv")
...
write.csv(mean.mn.Prcpfh, 
          file="Mean Monthly Rainfall of Tamale (1960-1987).csv")
...
dev.copy(png, filename="Mean Monthly Rainfall of Tamale (1960-1988).png",
         height = 750, width = 1000)
dev.off()

sum6 <- summary(mean.mn.Prcpfh)
write.csv(sum6,
          file="summary stats for mean monthly Prcp of Tamale(1960-1988).csv")
...
write.csv(mean.mn.Prcpsh,
          file="Mean Monthly Rainfall of Tamale (1989-2016).csv")
...
dev.copy(png, filename="Mean Monthly Rainfall of Tamale (1989-2017).png", 
         height = 750, width = 1000)
dev.off()

sum7 <- summary(mean.mn.Prcpsh)
write.csv(sum7,
          file="summary of mean monthly Rainfall of Tamale(1989-2016).csv")
...
#plot(mean.mn.Prcpfh, lwd=3, type="l", 
#     main="Mean Monthly Rainfall of Tamale- 1960-2017", 
#     xlab="Months", ylab="Rainfall(mm)", col="darkblue")

#lines(mean.mn.Prcpsh, col="red", lwd=3, type = "l")
...
ggplot(mean.mn.Prcpfh,aes(x=mean.mn.Prcpfh[,1])) + 
  ...
  geom_line(aes(y=mean.mn.Prcpsh[,2], col ="1989-2016"),lwd=2) +
  scale_colour_manual("",
...
dev.copy(png, filename = "Mean Monthly Rainfall of Tamale (1960-88-2017.png",
         width = 1000, height = 750)
dev.off()
...
Ann.rndys20_fh <- Ann.rdys20.Tamale[Ann.rdys20.Tamale[,1] >= "1960-01-01" &
                                   Ann.rdys20.Tamale[,1] <= "1988-01-01", ]

Ann.rndys20_sh <- Ann.rdys20.Tamale[Ann.rdys20.Tamale[,1] >= "1989-01-01" &
                                   Ann.rdys20.Tamale[,1] <= "2016-01-01", ]
...
dev.copy(png,filename="Comparing Days with Rainfall grt 20mm Tamale.png",
         width = 1000, height = 750)
dev.off
...
head(Prcp.mn.rdys20) 
Prcp.mn.rdysfh20 <- Prcp.mn.rdys20[Prcp.mn.rdys20[,1] >= "1960-01-31" &
                                     Prcp.mn.rdys20[,1] <= "1988-12-31", ] %>% drop_na()

Prcp.mn.rdysh20 <- Prcp.mn.rdys20[Prcp.mn.rdys20[,1] >= "1989-01-31" &
                                    Prcp.mn.rdys20[,1] <= "2016-12-31", ] %>% drop_na()
...
mean_daily_Tamalefh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,
                        ...
                        Mar_74,Mar_75,Mar_76,Mar_77,Mar_78,Mar_79,Mar_80,Mar_81,Mar_82,Mar_83,
                        Mar_84,Mar_85,Mar_86,Mar_87,Mar_88,Mar_89,Mar_90,Apr_91,Apr_92,Apr_93,
                        Apr_94,Apr_95,Apr_96,Apr_97,Apr_98,Apr_99,Apr_100,Apr_101,Apr_102,
...
Seasonal_cycle_Tamalefh <-data.frame(
  c(1:366),
  mean_daily_Tamalefh)

write.csv(Seasonal_cycle_Tamalefh, 
          file = "data_for_seasonal_cycle_of_Rainfall of Tamale(1960-1988).csv")
...
ggplot(Seasonal_cycle_Tamalefh, aes(x=c(1:366), y=mean_daily_Tamalefh)) + 
  geom_line(col="darkblue", lwd=1) + 
...
dev.copy(png, filename="Seasonal Cycle of Annual Rainfall of Tamale (1960-1988).png",
         height = 750, width = 1000)
dev.off()

sum8 <- summary(Seasonal_cycle_Tamalefh)
write.csv(sum8,
          file = "summary Stats for Seasonal Cycle of Ann. Prcp of Tamale (1960-1988).csv")
...
mean_daily_Tamalesh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,Jan_11,
                        Jan_12,Jan_13,Jan_14,Jan_15,Jan_16,Jan_17,Jan_18,Jan_19,Jan_20,Jan_21,
                        Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,Jan_29,Jan_30,Jan_31,
                        Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,Feb_37,Feb_38,Feb_39,Feb_40,Feb_41,
                        Feb_42,Feb_43, Feb_44,Feb_45,Feb_46,Feb_47,Feb_48,Feb_49,Feb_50,Feb_51,
                        ...
                        Mar_90,Apr_91,Apr_92,Apr_93,Apr_94,Apr_95,Apr_96,Apr_97,Apr_98,Apr_99,
                        Apr_100,Apr_101,Apr_102,Apr_103,Apr_104,Apr_105,Apr_106,Apr_107,Apr_108,Apr_109,Apr_110,Apr_111,Apr_112,Apr_113,Apr_114,Apr_115,Apr_116,Apr_117,Apr_118,Apr_119,Apr_120,May_121,May_122,May_123,May_124,May_125,May_126,May_127,May_128,May_129,May_130,May_131,May_132,May_133,May_134,May_135,May_136,May_137,May_138,May_139,May_140,May_141,May_142,May_143,May_144,May_145,May_146,May_147,May_148,May_149,May_150,May_151,Jun_152,Jun_153,Jun_154,Jun_155,Jun_156,Jun_157,Jun_158,Jun_159,Jun_160,Jun_161,Jun_162,Jun_163,Jun_164,Jun_165,Jun_166,Jun_167,Jun_168,Jun_169,Jun_170,Jun_171,Jun_172,Jun_173,Jun_174,Jun_175,Jun_176,Jun_177,Jun_178,Jun_179,Jun_180,Jun_181,Jul_182,Jul_183,Jul_184,Jul_185,Jul_186,Jul_187,Jul_188,Jul_189,Jul_190,Jul_191,Jul_192,Jul_193,Jul_194,Jul_195,Jul_196,Jul_197,Jul_198,Jul_199,Jul_200,Jul_201,Jul_201,Jul_203,Jul_204,Jul_205,Jul_206,Jul_207,Jul_208,Jul_209,Jul_210,Jul_211,Jul_212,Aug_213,Aug_214,Aug_215,Aug_216,Aug_217,Aug_218,Aug_219,Aug_220,Aug_221,Aug_222,Aug_223,Aug_224,Aug_225,Aug_226,Aug_227,Aug_228,Aug_229,Aug_230,Aug_231,Aug_232,Aug_233,Aug_234,Aug_235,Aug_236,Aug_237,Aug_238,Aug_239,Aug_240,Aug_241,Aug_242,Aug_243,Sep_244,Sep_245,Sep_246,Sep_247,Sep_248,Sep_249,Sep_250,Sep_251,Sep_252,Sep_253,Sep_254,Sep_255,Sep_256,Sep_257,Sep_258,Sep_259,Sep_260,Sep_261,Sep_262,Sep_263,Sep_264,Sep_265,Sep_266,Sep_267,Sep_268,Sep_269,Sep_270,Sep_271,Sep_272,Sep_273,Oct_274,Oct_275,Oct_276,Oct_277,Oct_278,Oct_279,Oct_280,Oct_281,Oct_282,Oct_283,Oct_284,Oct_285,Oct_286,Oct_287,Oct_288,Oct_289,Oct_290,Oct_291,Oct_292,Oct_293,Oct_294,Oct_295,Oct_296,Oct_297,Oct_298,Oct_299,Oct_300,Oct_301,Oct_302,Oct_303,Oct_304,Nov_305,Nov_306,Nov_307,Nov_308,Nov_309,Nov_310,Nov_311,Nov_312,Nov_313,Nov_314,Nov_315,Nov_316,Nov_317,Nov_318,Nov_319,Nov_320,Nov_321,Nov_322,Nov_323,Nov_324,Nov_325,Nov_326,Nov_327,Nov_328,Nov_329,Nov_330,Nov_331,Nov_332,Nov_333,Nov_334,Dec_335,Dec_336,Dec_337,Dec_338,Dec_339,Dec_340,Dec_341,Dec_342,Dec_343,Dec_344,Dec_345,Dec_346,Dec_347,Dec_348,Dec_349,Dec_350,Dec_351,Dec_352,Dec_353,Dec_354,Dec_355,Dec_356,Dec_357,Dec_358,Dec_359,Dec_360,Dec_361,Dec_362,Dec_363,Dec_364,Dec_365)

Seasonal_cycle_Tamalesh <-data.frame(
  c(1:366),
  mean_daily_Tamalesh
  )

write.csv(Seasonal_cycle_Tamalesh, 
          file = "data_for_seasonal_cycle_of_Rainfall of Tamale(1989-2016).csv")
...
ggplot(Seasonal_cycle_Tamalesh, aes(x=c(1:366), y=mean_daily_Tamalesh)) +
  geom_line(col="darkblue", lwd=1) + 
...
dev.copy(png, filename="Seasonal Cycle of Annual Rainfall of Tamale (1989-2017).png",
         height = 750, width = 1000)
dev.off()



#plot(Seasonal_cycle_Tamalefh, lwd=1, type="l", col="darkblue", main="Seasonal Rainfall Cycle of Tamale- 1960-2017", xlab="Days", ylab="Rainfall(mm)")
#lines(sss.1, col="blue", lwd=3)
#lines(Seasonal_cycle_Tamalesh, type="l", col="darkblue")
#lines(bb.1, lwd=3, col="red")
#legend("topright", col=c("blue","red"), legend = c("1960-1988","1989-2017"), bty = "n", lty = 1, lwd=3)


ggplot(Seasonal_cycle_Tamalefh, aes(x=Seasonal_cycle_Tamalefh[,1])) +
  geom_line(aes(y=Seasonal_cycle_Tamalefh[,2]), lwd=.25) +
  geom_line(aes(y=sss.1[,2], col="1960-1988"),lwd=1.25) +
  geom_line(aes(y=Seasonal_cycle_Tamalesh[,2]),lwd=.25) + 
  geom_line(aes(y=bb.1[,2],col="1989-2016"), lwd=1.25) +
  scale_colour_manual("",
                      values = c("1960-1988"="darkblue","1989-2016"="red")) +
...
dev.copy(png, filename="Seasonal Cycle of Rainfall of Tamale(1960-88-2016).png",
         width = 1000, height=750)
dev.off()
...
ggplot(data=Seas,
       aes(x=dates,y=Prcp)) +
  geom_line(col="darkblue", lwd=2) +
  ggtitle(" Seasonal Rainall (1960-2016)\n Tamale") + xlab("Month") +
  ylab("Rainfall(mm)") + 
  theme(plot.title = element_text(size=18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13)) +
...
#Monthly Seasonal Cycle of Prcp
head(Prcp)
sj <- subset(Prcp, format.Date(dates,  "%m")=="01")
sf <- subset(Prcp, format.Date(dates, "%m")=="02")
sm <- subset(Prcp, format.Date(dates, "%m")=="03")
sa <- subset(Prcp, format.Date(dates, "%m")=="04")
sma <- subset(Prcp, format.Date(dates, "%m")=="05")
sju <- subset(Prcp, format.Date(dates, "%m")=="06")
sjl <- subset(Prcp, format.Date(dates, "%m")=="07")
sau <- subset(Prcp, format.Date(dates, "%m")=="08")
ss <- subset(Prcp, format.Date(dates, "%m")=="09")
so <- subset(Prcp, format.Date(dates, "%m")=="10")
sn <- subset(Prcp, format.Date(dates, "%m")=="11")
sd <- subset(Prcp, format.Date(dates, "%m")=="12")
...
ggplot(data=dts, aes(x=dts[,1], y=dts[,2])) + geom_line(col="darkblue", lwd=2) +
  geom_line(data = )
...
#Prcp_fh.anom.v <- (Prcp_fh$Prcp - lng.mn.Prcp_fh)/sd.Prcp_fh
#Prcp_fhtmale.anom <- data.frame(Prcp_fh$date, Prcp_fh.anom.v)
#ggplot(Prcp_fhtmale.anom, aes(Prcp_fh$date, Prcp_fh.anom.v, ymin = 0,ymax = Prcp_fh.anom.v)) + 
#  geom_linerange(data = Prcp_fhtmale.anom, aes(colour = ifelse(Prcp_fh.anom.v >0, "Positive", "Negative")),stat = "identity",
#                                                                                                                   position = "identity",size=2) + 
#  theme(legend.title = element_text(size = 2, colour = F)) + (scale_x_date(date_breaks="4 years",date_labels="%Y"))  +
#  geom_hline(yintercept=0) + labs(title="Index of Annual Rainfall of \n Tamale (1960-1988)", x="Years", y="Index")
#dev.copy(png, filename="Index of Annual Rainfall of Tamale (1960-2017).png", height = 750, width = 1000)
#dev.off()
...
#Prcp_sh.anom.v <- (Prcp_sh$Prcp - lng.mn.Prcp_sh)/sd.Prcp_sh
#Prcp_shtmale.anom <- data.frame(Prcp_sh$date, Prcp_sh.anom.v)
#ggplot(Prcp_shtmale.anom, aes(Prcp_sh$date, Prcp_sh.anom.v, ymin = 0,ymax = Prcp_sh.anom.v)) + 
#  geom_linerange(data = Prcp_shtmale.anom, aes(colour = ifelse(Prcp_sh.anom.v >0, "Positive", "Negative")),stat = "identity",
#                                                                                                              position = "identity",size=2) + 
#  theme(legend.title = element_text(size = 2, colour = F)) + (scale_x_date(date_breaks="3 year",date_labels="%Y"))  +
#  geom_hline(yintercept=0) + labs(title="Index of Annual Rainfall of Tamale \n (1989-2016)", x="Years", y="Index")
#dev.copy(png, filename="Index of Annual Rainfall of Tamale (1989-2017).png", height = 750, width = 1000)
#dev.off()
