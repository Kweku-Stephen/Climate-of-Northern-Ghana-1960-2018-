...
write.csv(Tmax.ann.df, 
          file ="Mean Annual Tmax of Yendi(1960-2017).csv")
...
ggplot(Tmax.ann.df, aes(x=date, y=Tmax)) + 
  ...
  annotate("text",x = Tmax.ann.df[Tmax.ann.df[,1] == "1974-12-31", ]$date,
            y = 34.5, cex = 5, label = "P-value = < 2.22e-16") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Annual Mean Maximum Temperature of Yendi (1960-2017).png",
         width = 750, height = 1000)
dev.off()
         
sumx1 <- summary(Tmax.ann.df)
write.csv(sumx1,
          file="Summary Stats for Annual Max Tmp of Yendi(1960-2017).csv")
#or
...
#                             Mayy$Tmax,Junee$Tmax,Julyy$Tmax,Augus$Tmax,Septe$Tmax,
#                             Octo$Tmax,Novem$Tmax,Decem$Tmax)
...
write.csv(Mn.mn.tmx, 
          file="Mean Monthly Tmax of Yendi(1960-2017).csv")
...
dev.copy(png, filename="Mean Monthly Maximum Tmp of Yendi (1960-2017).png",
...
write.csv(sumx1,
          file="Summary Stats for Mean Monthly Max Tmp of Yendi(1960-2017).csv")
#or
...
mean_dailytmx_Yendi<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,
...
Seasonal_cycle_Yenditmx <-data.frame(
  c(1:366),
  mean_dailytmx_Yendi
)

write.csv(Seasonal_cycle_Yenditmx,
          file = "data_for_seasonal_cycle_of_Max tmp of Yendi(1960-2017).csv")
...
ggplot(Seasonal_cycle_Yenditmx, aes(x=c(1:366), y=mean_dailytmx_Yendi)) + 
...
dev.copy(png, 
         filename="Seasonal Cycle of Mean Annual Maximum Temperature of Yendi (1960-2017).png",
         width = 1000, height = 750)
dev.off()

sumx3 <- summary(Seasonal_cycle_Yenditmx)
write.csv(sumx3,
          file="Summary Stats for Seasonal Cycle of Max Tmp of Yendi(1960-2017).csv")



#Indexing of Max tmp of Tamale (1960-2017)
...
write.csv(Tmax.ann.df.anom, 
          file="Index of Annual Max Tmp of Yendi (1960-2017).csv")
...
dev.copy(png, filename="Anomalies of Mean Annual Maximum Temperature of Yendi (1960-2017).png",
         width = 1000, height = 750)
dev.off()
...
write.csv(sumx2,
          file="Summary Stats for Max Tmp Anomaly of Yendi(1960-2017).csv")
#or
...
write.csv(Tmax_fh, 
          file="Annual Max.Tmp of Yendi (1960-88).csv")
...
ggplot(Tmax_fh, aes(x=Tmax_fh$date, y=Tmax_fh$Tmax)) + 
  ...
  labs(title='Maximum Temperature (1960-1988)\n Yendi', 
       x="Year", y=yyy) +
  scale_x_date(date_labels = "%Y",date_breaks = "4 years" ) + annotate("text",
          x = Tmin_fh[Tmin_fh[,1] == "1965-12-31", ]$date,  y = 34.0, cex = 5,
          label = "P-value = 0.030992") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))
  
dev.copy(png,
         filename="Annual Mean Annual Maximum Temperature of Yendi (1960-1988).png",
         width = 1000, height = 750)
dev.off()

sumx3 <- summary(Tmax_fh)
write.csv(sumx3,
          file="Summary Stats for Annual Max Tmp of Yendi(1960-1988).csv")
#or
...
Janx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date, 
                                      "%m")=="01")$Tmax, na.rm = T)

Febx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date, 
                                      "%m")=="02")$Tmax, na.rm = T)

Marchx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                     "%m")=="03")$Tmax, na.rm  = T)

Aprilx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                     "%m")=="04")$Tmax, na.rm = T)

Mayx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                       "%m")=="05")$Tmax, na.rm = T)

Junex.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                        "%m")=="06")$Tmax, na.rm =T)

Julyx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                        "%m")=="07")$Tmax, na.rm =T)

Augustx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date, 
                                        "%m")=="08")$Tmax, na.rm =T)

Septemberx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                       "%m")=="09")$Tmax, na.rm = T)

Octoberx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                      "%m")=="10")$Tmax, na.rm = T)

Novemberx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                        "%m")=="11")$Tmax, na.rm = T)

Decemberx.fh <- mean(subset(Tmax.mn.dffh, format.Date(Tmax.mn.dffh$date,
                                         "%m")=="12")$Tmax, na.rm =T)
...
write.csv(mean.mn.Tmaxfh,
          file = "Mean Monthly Tmax of Yendi(1960-1988).csv")
...
dev.copy(png, filename="Mean Monthly Maximum Temperature of Yendi (1960-1988).png",
         width = 1000, height = 750)
dev.off()

sumx4 <- summary(mean.mn.Tmaxfh)
write.csv(sumx4,
          file="Summary Stats for mean monthly Max Tmp of Yendi(1960-1988).csv")
#or
...
write.csv(Tmax_sh, 
          file="Annual Tmax of Yendi (1989-2016).csv")
ggplot(Tmax_sh, aes(x=Tmax_sh$date, y=Tmax_sh$Tmax)) + 
  geom_line(col="firebrick", lwd=2) + geom_smooth(method = lm, col="blue") + 
  labs(title='Maximum Temperature (1989-2017)\n Yendi',
       x="Year", y=yyy) + 
  scale_x_date(date_labels = "%Y", date_breaks = "3 years") + 
  annotate("text", x = Tmax_sh[Tmax_sh$date == "1997-12-31", ]$date,
           y = 33.5, cex = 5, label = "P-value = 0.010174") +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))

dev.copy(png, filename="Mean Annual Maximum Temperature of Yendi (1989-2017).png",
         width = 1000, height = 750)
dev.off()

sumx5 <- summary(Tmax_sh)
write.csv(sumx5,
          file="Summary Stats for Annual Max Tmp of Yendi(1989-2017).csv")
#or
...
Janx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date, 
                                               "%m")=="01")$Tmax, na.rm = T)

Febx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date, 
                                               "%m")=="02")$Tmax, na.rm = T)

Marchx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                 "%m")=="03")$Tmax, na.rm  = T)

Aprilx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                 "%m")=="04")$Tmax, na.rm = T)

Mayx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                               "%m")=="05")$Tmax, na.rm = T)

Junex.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                "%m")=="06")$Tmax, na.rm =T)

Julyx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                "%m")=="07")$Tmax, na.rm =T)

Augustx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date, 
                                                  "%m")=="08")$Tmax, na.rm =T)

Septemberx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                     "%m")=="09")$Tmax, na.rm = T)

Octoberx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                   "%m")=="10")$Tmax, na.rm = T)

Novemberx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                    "%m")=="11")$Tmax, na.rm = T)

Decemberx.sh <- mean(subset(Tmax.mn.dfsh, format.Date(Tmax.mn.dfsh$date,
                                                    "%m")=="12")$Tmax, na.rm =T)


#creating a vector
mean.mn.Tmaxsh.v <- c(Janx.sh,Febx.sh,Marchx.sh,Aprilx.sh,Mayx.sh,Junex.sh,
                    Julyx.sh,Augustx.sh,Septemberx.sh,Octoberx.sh,
...
write.csv(mean.mn.Tmaxsh,
          file = "Mean Monthly Tmax of Yendi(1989-2017.csv")

ggplot(mean.mn.Tmaxsh, aes(x=date.mn, y=mean.mn.Tmaxsh.v)) + 
  geom_line(col="firebrick", lwd=2) + 
  scale_x_date(date_breaks = "1 month", date_labels = "%b") +
  labs(title="Mean Monthly Mximum Temperature (1989-2017)\n Yendi",
       x="Month",y=yyy) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))
...
dev.copy(png,
         filename="Mean Monthly Maximum Temperature of Yendi (1989-2017).png",
         width = 1000, height = 750)
dev.off()

sumx6 <- summary(mean.mn.Tmaxsh)
write.csv(sumx6,
          file="Summary Stats for mean Monthly Max Tmp of Yendi(1989-2017).csv")
#or
...
#plot(mean.mn.Tmaxfh, type="l", col="darkblue",ylim=c(28,38) ,
#     main="Mean Monthly Max Tmp of Yendi - 1960-2017", 
#     xlab="Months", ylab=yyy, lwd=3)
...
#ggplot(mean.mn.Tmaxsh,aes(x=mean.mn.Tmaxfh[,1], y=mean.mn.Tmaxfh[,2])) + 
...
#  ylab(yyy) + ggtitle("Mean Monthly Max Tmp of Yendi\n (1960-2017)") 
...
dev.copy(png, filename = "Mean Monthly Max Tmp of Yendi (1960-88-2017).png",
         width = 1000, height = 750)
dev.off()
...
for (i in 1:12) {
  storage7[i] <- ((r*100)/mean.mn.Tmaxfh[,2])[i]
}
...
mean_dailytmx_Yendifh<- c(Jan_1,Jan_2, Jan_3, Jan_4, Jan_5,Jan_6,Jan_7,Jan_8,Jan_9,Jan_10,
                          Jan_11, Jan_12,Jan_13,Jan_14,Jan_15,Jan_16,Jan_17,Jan_18,Jan_19,
                          Jan_20,Jan_21,Jan_22,Jan_23,Jan_24,Jan_25,Jan_26,Jan_27,Jan_28,
                          Jan_29,Jan_30,Jan_31,Feb_32,Feb_33,Feb_34,Feb_35,Feb_36,Feb_37,
Seasonal_cycle_Yenditmxsh <-data.frame(
  c(1:366),
  mean_dailytmx_Yendish
)

write.csv(Seasonal_cycle_Yenditmxsh, 
          file = "data_for_seasonal_cycle_of_Max tmp of Yendi(1989-2016).csv")
bb <- ksmooth(
  c(1:366),
  mean_dailytmx_Yendish,
  bandwidth = 15
...
ggplot(Seasonal_cycle_Yenditmxsh, aes(x=c(1:366), y=mean_dailytmx_Yendish)) +
  geom_line(col="firebrick", lwd=1) + 
  labs(title="Seasonal Maximum Temperature (1989-2017)\n Yendi",
       x="Day", y=yyy) + 
  geom_line(data = bb.1, aes(x=x, y=y), col="blue", lwd=1) +
  theme(plot.title = element_text(size = 18, hjust = 0.5, face = "bold"),
        axis.text = element_text(size = 13),
        axis.title = element_text(size = 13))
...
sumx10 <- summary(Seasonal_cycle_Yenditmxsh)
write.csv(sumx10,
          file="Summary Stats for Seasonal Cyc. of Max Tmp of Yendi(1989-2017).csv")



#ggplot(Seasonal_cycle_Yenditmxfh, aes(x=Seasonal_cycle_Yenditmxfh[,1], 
#                                      y=Seasonal_cycle_Yenditmxfh[,2])) + 
#  geom_line(col="darkblue", lwd=.25) + geom_line(data=aa.1, mapping = aes(x=x,y=y),
#                                                 col="darkgreen", lwd=1.25) +
# geom_line(data=Seasonal_cycle_Yenditmnsh, mapping = aes(Seasonal_cycle_Yenditmxsh[,1],
#                                                         y=Seasonal_cycle_Yenditmxsh[,2]),
#            col="darkblue", lwd=.25) + geom_line(data=bb.1, mapping = aes(x=x,y=y),
#                                                col="red", lwd=1.25) + 
#  labs(title = "Max Tmp Seasonal Cycle of Yendi \n (1960-2017", 
#      x="Days",y=yyy)

#dev.copy(png, filename="Seasonal Cycle of Max of Yendi (1960-88-2017).png",
#         width= 1000, height = 750)
#dev.off()


ggplot(data=Seasonal_cycle_Yenditmxfh,aes(x=Seasonal_cycle_Yenditmxfh[,1]),lwd=.25) +
  geom_line(aes(y=Seasonal_cycle_Yenditmxfh[,2]), lwd=.25) +
  geom_line(aes(y = aa.1[,2], colour = "1960-1988"), lwd=1.5) +
  geom_line(aes(y = Seasonal_cycle_Yenditmxsh[,2]), lwd=.25) +
  geom_line(aes(y=bb.1[,2], colour = "1989-2017"), lwd=1.5) +
  scale_colour_manual("", 
                      values = c("1960-1988"="darkblue", "1989-2017"="red")) +
  xlab("Day") + ylab(yyy) + 
...
dev.copy(png, filename="Seasonal Cycle of Max Tmp of Yendi(1960-88-2017).png", 
         width = 1000, height = 750)
dev.off()
...
#ggplot(Tmax_fh_anom, aes(Tmax_fh$date, Tmax_fh_anom.v, ymin = 0,
#                         ymax = Tmax_fh_anom.v)) + 
...
#  geom_hline(yintercept=0) + 
#  labs(title="Index of Annual Maximum Tmp of Yendi \n (1960-1988)", x="Years", y="Index")

#dev.copy(png, filename="Index of Annual Maximum Temperature of Yendi (1960-1988).png",
#         width = 1000, height = 750)
#dev.off()
...
#dev.copy(png, filename="Index of Annual Maximum Temperature of Yendi (1989-2017).png",
#         width = 1000, height = 750)
#dev.off()
